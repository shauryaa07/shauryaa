import { User as UserIcon, MicOff, UserPlus } from "lucide-react";
...
export default function VideoThumbnail({
  ...
  return (
    <div
      className="relative rounded-lg overflow-hidden bg-muted dark:bg-muted group w-full aspect-video"
